...
test_that("plot_community returns error when expected", {
    expect_error(plot_community(Scores, gsTopology, colorBy = "robustZ", communityMethod = "cluster_random"), "CommunityMethod must be a community detection algorithm specified in the description")
