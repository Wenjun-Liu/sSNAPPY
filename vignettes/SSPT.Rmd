---
title: "SSPT: Singel Sample Pathway Perturbation Testing"
author:
...
This vignette demonstrates how to use the package `SSPT` to compute single sample pathway perturbation scores by incorporating pathway topologies, utilize sample permutation to test the significance of individual scores or compare average pathway activities across treatment. 
...
Output of the `r generate_PermutedScore()` function is a list where each element is a vector of permuted perturbation scores for a pathway. 
